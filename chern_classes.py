...
class VectorBundle:
    ...
    def __init__(self, name, dim, chern_classes=None, truncate=None, base_ring=None):
        ...
        # these will be in the unique polynomial ring generated by the c_i's over th base ring which is assumed to
        # be QQ if none is given.
        ...
        if chern_classes:
            ...
            if not base_ring:
                base_ring = QQ
            self.chern_ring = PolynomialRing(base_ring,variables)
            self.chern_classes = [self.chern_ring.one()]
